	...
	public void actionPerformed(ActionEvent e) {
		...
		switch (e.getActionCommand()) {
			...
			case "Valider l'ajout d'une livraison":
				...
				System.out.println("id enlevement: " + pointEnlevement.getId() + "id livraison associ̩: " + pointEnlevement.getIdLivraison() + "temps" + pointEnlevement.getTempsEnlevement());
				System.out.println("id livraison: " + pointLivraison.getId() + "id enlevement associ̩: " + pointLivraison.getIdEnlevement() + "temps" + pointLivraison.getTempsLivraison());
