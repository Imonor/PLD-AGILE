	...
	public void actionPerformed(ActionEvent e) {
		...
		switch (e.getActionCommand()) {
			...
			case "Valider l'ajout d'une livraison":
				...
				System.out.println("id enlevement: " + pointEnlevement.getId() + "id livraison associ√©: " + pointEnlevement.getIdLivraison());
				System.out.println("id livraison: " + pointLivraison.getId() + "id enlevement associ√©: " + pointLivraison.getIdEnlevement());
			...
			case "Modifier l'ordre de la tournÈe":
				System.out.println("Modifier tournÈe");
				fenetre.afficherModificationTournee();
			break;			

			case "Annuler la derni√®re modification":
